...
export const darkTheme = {
  ...
  hunk: "#9ebdf5", addedBg: "#18382e", removedBg: "#402a2b", added: "#8cddb0",
};
...
export const themes = {
  terminal: {
    ...
    addedBg: RGBA.defaultBackground(), removedBg: RGBA.defaultBackground(), added: RGBA.fromIndex(2),
  },
  dark: darkTheme,
  light: {
    ...
    hunk: "#345da7", addedBg: "#e2f3e5", removedBg: "#fbe5e5", added: "#176b36",
  },
  gruvbox: {
    ...
    hunk: "#83a598", addedBg: "#323b26", removedBg: "#442b28", added: "#b8bb26",
  },
  tokyonight: {
    ...
    hunk: "#7aa2f7", addedBg: "#20332d", removedBg: "#3b2637", added: "#9ece6a",
  },
  catppuccin: {
    ...
    hunk: "#89b4fa", addedBg: "#2b3835", removedBg: "#402d3e", added: "#a6e3a1",
  },
  vesper: {
    ...
    hunk: "#ffc799", addedBg: "#1b2421", removedBg: "#241919", added: "#99ffe4",
  },
